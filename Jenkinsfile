...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.52.213:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#cicd-pipeline-project-oadeosun', //update and provide your channel name
